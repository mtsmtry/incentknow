...
exports.UtilsSpaceAuthorization = void 0;
var utils_base_1 = require("./utils_base");
var client_sql_1 = require("./client_sql");
var base = utils_base_1.UtilsBase;
var UtilsSpaceAuthorization = /** @class */ (function () {
    function UtilsSpaceAuthorization() {
    }
    UtilsSpaceAuthorization.hasSpaceAuth = function (user, space, auth) {
                ...
                switch (_e.label) {
                    case 0:
                        belongSpace = function () {
                            ...
                            var member = base.conn.getRepository(client_sql_1.SpaceMember).findOne({ space: space, user: user });
    ...
    UtilsSpaceAuthorization.checkSpaceAuth = function (user, space, auth) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return UtilsSpaceAuthorization;
}());
exports.UtilsSpaceAuthorization = UtilsSpaceAuthorization;
//# sourceMappingURL=utils_authority.js.map