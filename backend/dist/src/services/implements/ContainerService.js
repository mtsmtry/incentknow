...
var ContainerService = /** @class */ (function (_super) {
    ...
    function ContainerService(ctx, containers, auth) {
        var _this = _super.call(this, ctx) || this;
        _this.containers = containers;
        _this.auth = auth;
        return _this;
    }
    ContainerService.prototype.getContainers = function (spaceId) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.containers.fromContainers().bySpace(space.id).selectRelated().getMany()];
