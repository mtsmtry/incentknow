...
foreign import setHighlightGutterLineImpl
  :: Fn2 Boolean Editor (Effect Unit)

setHighlightGutterLine
  :: Boolean -> Editor -> Effect Unit
setHighlightGutterLine shouldHighlight self =
  runFn2 setHighlightGutterLineImpl shouldHighlight self
...
setMinLines :: Number -> Editor ->  Effect Unit
setMinLines = setOption "minLines"

setMaxLines :: Number -> Editor ->  Effect Unit
