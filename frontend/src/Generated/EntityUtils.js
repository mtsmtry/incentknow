...
}; exports.buildBlockData = type => {
    return options => {
        if (type instanceof E.Paragraph) {
            if (options.text instanceof Data_Maybe.Nothing) {
                return Data_Maybe.Nothing.value;
            }
            const result = new E.ParagraphBlockData(options.text.value0);
            return new Data_Maybe.Just(result);
        } if (type instanceof E.Header) {
            if (options.level instanceof Data_Maybe.Nothing) {
                return Data_Maybe.Nothing.value;
            } if (options.text instanceof Data_Maybe.Nothing) {
                return Data_Maybe.Nothing.value;
            }
...
}; exports.buildMaterialData = type => {
    return options => {
        if (type instanceof E.MaterialTypeFolder) {
            const result = new E.FolderMaterialData();
            return new Data_Maybe.Just(result);
        } if (type instanceof E.MaterialTypeDocument) {
            if (options.document instanceof Data_Maybe.Nothing) {
                return Data_Maybe.Nothing.value;
            }
...
exports.getMaterialCompositionType = src => {
...
}; exports.buildMaterialComposition = type => {
    return options => {
        if (type instanceof E.Creation) {
            if (options.propertyId instanceof Data_Maybe.Nothing) {
                return Data_Maybe.Nothing.value;
            ...
            return new Data_Maybe.Just(result);
        } if (type instanceof E.Move) {
            if (options.materialId instanceof Data_Maybe.Nothing) {
                return Data_Maybe.Nothing.value;
            }
