...
export function toMaterialRevisionId(strc: MaterialRevisionStructure) {
...
export function toFocusedMaterialRevisionFromDraft(draft: MaterialDraft): FocusedMaterialRevision {
    return {
