...
var ServiceMaterial = /** @class */ (function () {
    function ServiceMaterial() {
    }
    ServiceMaterial._getChangeType = function (prevLength, length) {
        // 文字数で変更の種類を分類
    ...
    ServiceMaterial.startMaterialEditing = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var user, material, draft, forkedCommit, editing;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, base.getMyUser()];
                    case 1:
                        user = _a.sent();
                        return [4 /*yield*/, client_sql_1.Material.findOne({ entityId: args.materialId })];
                    case 2:
                        material = _a.sent();
                        return [4 /*yield*/, client_sql_1.MaterialDraft.findOne({ material: material })];
                    case 3:
                        draft = _a.sent();
                        if (!!draft) return [3 /*break*/, 5];
                        draft = client_sql_1.MaterialDraft.create({
                            material: material,
                            user: user
                        });
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, client_sql_1.MaterialCommit.findOne({ entityId: args.forkedCommitId })];
                    case 6:
                    ...
                    case 8:
                        editing = _a.sent();
                        return [4 /*yield*/, client_sql_1.MaterialDraft.update(draft, { currentEditing: editing })];
                    case 9:
                        _a.sent();
                        _a.label = 10;
                    case 10: return [2 /*return*/, utils_entities_1.toRelatedMaterialDraft(draft)];
                }
            });
        });
    };
    ServiceMaterial.startBlankMaterialEditing = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        return [2 /*return*/, utils_entities_1.toRelatedMaterialDraft(draft)];
                }
            });
        });
    };
    ServiceMaterial.editMaterial = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [4 /*yield*/, client_sql_1.MaterialDraft.findOne({ entityId: args.materialDraftId })];
                    case 2:
                        draft = _a.sent();
                        if (!draft) {
                        ...
                        if (!draft.intendedContentDraftId) return [3 /*break*/, 4];
                        return [4 /*yield*/, client_sql_1.ContentDraft.update(draft.intendedContentDraftId, { updatedAt: Date.now() })];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
                        if (!(draft.data != args.data)) return [3 /*break*/, 8];
                        changeType = this._getChangeType(draft.data.length, args.data.length);
                        if (!(draft.changeType != client_sql_1.ChangeType.REMOVE && changeType == client_sql_1.ChangeType.REMOVE)) return [3 /*break*/, 6];
                        ...
                        return [4 /*yield*/, Promise.all([
                                snapshot.save(),
                                client_sql_1.MaterialDraft.update(draft, { data: args.data, changeType: changeType })
                            ])];
                    case 5:
                        _a.sent();
                        return [2 /*return*/, utils_entities_1.toRelatedMaterialSnapshot(snapshot)];
                    case 6: return [4 /*yield*/, client_sql_1.MaterialDraft.update(draft, { data: args.data })];
                    case 7:
                        _a.sent();
                        _a.label = 8;
    ...
    ServiceMaterial.commitMaterial = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        return [4 /*yield*/, client_sql_1.MaterialDraft
                    ...
                    case 2:
                        ...
                        commit = client_sql_1.MaterialCommit.create({
                            editing: client_sql_1.MaterialEditing.create({ id: draft.currentEditingId }),
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, Promise.all([
                                commit.save(),
                                client_sql_1.MaterialDraft.update(draft, { data: null, currentEditing: null }),
                    ...
                    case 9:
                        material = _c.sent();
                        if (!draft.intendedContentDraft) return [3 /*break*/, 15];
                        return [4 /*yield*/, client_sql_1.ContentDraft.update(draft.intendedContentDraft, { updatedAt: Date.now() })];
                    case 10:
                        _c.sent();
                        if (!draft.intendedContentDraft.content) return [3 /*break*/, 13];
                    ...
                    case 11:
                        _c.sent();
                        // update content
                        return [4 /*yield*/, client_sql_1.Content.update(draft.intendedContentDraft.content, { updaterUser: user })];
                    case 12:
                        // update content
                        _c.sent();
                        return [3 /*break*/, 14];
                    case 13: throw "The parent content have not be committed";
                    case 14:
                        material.content = draft.intendedContentDraft.content;
                        return [3 /*break*/, 18];
                    case 15:
                        if (!draft.intendedSpace) return [3 /*break*/, 17];
                        // check auth
                    ...
                    case 16:
                        ...
                        return [3 /*break*/, 18];
                    case 17: throw "Neither space nor content is specified";
                    case 18:
                    ...
                    case 19:
                        ...
                        _c.label = 20;
                    case 20: return [2 /*return*/, { commitId: commit.entityId }];
                }
            });
        });
    };
    ServiceMaterial.getMaterial = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        material = _a.sent();
                        return [4 /*yield*/, client_sql_1.MaterialDraft.findOne({ user: user, material: material })];
                    case 3:
                        draft = _a.sent();
    ...
    ServiceMaterial.getMaterialDrafts = function () {
        return __awaiter(this, void 0, void 0, function () {
            var user, drafts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        drafts = _a.sent();
                        return [2 /*return*/, drafts.map(utils_entities_1.toRelatedMaterialDraft)];
                }
            });
        });
    };
    ServiceMaterial.getMaterialDraft = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var user, draft;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        draft = _a.sent();
                        return [2 /*return*/, utils_entities_1.toFocusedMaterialDraft(draft)];
                }
            });
        });
    };
    ServiceMaterial.getMaterialCommits = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var user, commits;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [4 /*yield*/, client_sql_1.MaterialCommit
                    ...
                    case 2:
                        commits = _a.sent();
                        return [2 /*return*/, commits.map(utils_entities_1.toRelatedMaterialCommit)];
                }
            });
        });
    };
    // include snapshot
    ServiceMaterial.getMaterialEditing = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var user, editing;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ServiceMaterial.getMaterialSnapshot = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var snapshot;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ServiceMaterial.getMaterialCommit = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var commit;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_sql_1.MaterialCommit.findOne({ entityId: args.commitId }, { select: ["data"] })];
                    case 1:
                        commit = _a.sent();
                        return [2 /*return*/, utils_entities_1.toFocusedMaterialCommit(commit)];
                }
            });
        });
    };
...
//# sourceMappingURL=service_material.js.map