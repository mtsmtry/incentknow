...
type State
  = { spaceId :: SpaceId, formatId :: FormatId, 
    contents :: Array Content, subId :: Maybe SubscriptionId }
...
render state = 
  HH.div [ css "page-cmp-timeline" ] (map renderItem state.contents)
  where
...
handleAction = case _ of
  ...
  ChangeContents contents ->
    H.modify_ _ { contents = sortBy compareContent contents }
    where
